  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-6">
        <div className="aspect-video bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center max-h-64 overflow-hidden">
          {course.thumbnailUrl ? (
        ...
        <div className="p-6">
          ...
          {course.description && (
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">{course.description}</p>
          )}
          ...
          {(course.registrationStartDate || course.educationStartDate || course.location || course.instructor) && (
            <div className="bg-gray-50 dark:bg-gray-750 rounded-lg p-3 mb-4 space-y-1.5 text-xs text-gray-600 dark:text-gray-400">
          ...
          {enrollment ? (
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full mt-1.5 py-2 text-xs text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                수강 취소
              </button>
            </div>
          ) : (
